...
export const EN_TRANSLATIONS = {
    ...
    "gbLifetimeIsaLabel": "Lifetime ISA (LISA)",
    "gbLifetimeIsaLimitLabel": "LISA annual payment limit",
    "gbLifetimeIsaBonusLabel": "Estimated government bonus on current input: {amount}",
    "gbLifetimeIsaNote": "LISA contributions can continue until age {contributionAge}; for retirement, penalty-free access is normally from age {accessAge}. LISA payments also count toward the overall ISA annual allowance.",
    ...
    "caEmploymentIncomeLabel": "Annual employment income (CPP/QPP & EI)",
    "caEmploymentIncomeGuide": "Enter employment earnings subject to payroll deductions. If left at 0, annual total income is used for backward compatibility.",
    "caCppEiLabel": "{plan} contributions + EI + QPIP",
    "caCppEiSub": "{plan} employee contribution {pension} + EI {ei} + QPIP {qpip} (QPIP in Quebec only)",
    ...
    "caQppEarlyRateGuide": "For QPP, the reduction before age 65 varies from 0.5% to 0.6% per month depending on the pension amount. Use the rate shown in your Retraite Québec estimate when available.",
    "caQppAnnualSub": "Retraite Québec estimate × claim-age adjustment",
    ...
    "caProvincialTaxLabel": "Provincial Tax ({province}, est.)",
    "caProvincialTaxUnsupportedValue": "Not modelled",
    "caProvincialTaxUnsupportedSub": "Only Ontario is automatically calculated for now. Other provincial/territorial tax is excluded.",
    "caOntarioTaxSub": "Includes Ontario surtax {surtax} and Ontario Health Premium {premium}",
    "caQuebecAbatementLabel": "Quebec federal tax abatement",
    "caQuebecAbatementSub": "{pct} reduction of Basic Federal Tax",
    ...
    "caTaxSourceNote": "Federal income tax, capital gains, CPP/QPP contributions, EI premiums and Quebec QPIP are estimates based on published {taxYear} figures. Provincial income tax is automated for Ontario and Quebec, including the 16.5% Quebec federal tax abatement. Other provinces/territories, dividend tax credits and AMT are not implemented.",
    "caTfsaLabel": "TFSA",
    ...
    "caTfsaOfficialRoomLabel": "TFSA room available on January 1 (if known)",
    "caTfsaOfficialRoomGuide": "Enter the current-year room calculated from your own transaction records if known. If left at 0, the app estimates it as the annual limit + prior unused room + prior-year withdrawals.",
    "caTfsaPriorUnusedLabel": "Unused TFSA room carried from prior years",
    "caTfsaPriorWithdrawalLabel": "TFSA withdrawals made last year",
    "caTfsaPriorWithdrawalGuide": "Last year's withdrawals are restored to contribution room on January 1. Withdrawals made this year do not restore room until next year.",
    "caTfsaRoomTotalSub": "Annual dollar limit: {amount}. Actual room can also include unused room and prior-year withdrawals",
    "caTotalAssetsLabel": "Total Assets (all four accounts)",
    "caTotalAssetsSub": "TFSA + RRSP + non-registered account + cash savings combined",
    "caTotalTaxLabel": "Total tax & payroll deductions (estimate)",
    "caTotalTaxSub": "Income tax + capital gains + CPP/QPP + EI + QPIP − RRSP tax saving",
    ...
    "auDivision296Title": "Division 296 (additional tax on large super balances)",
    "auDivision296BalanceLabel": "Year-end Total Super Balance (TSB)",
    "auDivision296BalanceGuide": "Enter the combined year-end balance of all super interests for 2026–27.",
    "auDivision296EarningsLabel": "Realised super earnings for the year",
    "auDivision296EarningsGuide": "Enter realised earnings relevant to the Division 296 calculation.",
    "auDivision296TaxLabel": "Estimated Division 296 additional tax",
    "auDivision296TaxSub": "Estimate: 15% on the $3m–$10m balance slice and 25% above $10m",
    "auDivision296Note": "Applies from 1 July 2026. This is a simplified realised-earnings estimate; the ATO assessment may differ because of statutory adjustments and exclusions.",
    ...
    "auPartnerCurrentAgeLabel": "Partner's current age",
    "auPartnerCurrentAgeGuide": "Used to determine automatically when your partner reaches Age Pension age ({age}).",
    "auPartnerSuperLabel": "Partner's current super balance",
    "auPartnerSuperGuide": "Excluded from Age Pension assets and deeming while the partner is under Age Pension age and has not started a super income stream.",
    "auPartnerSuperContributionLabel": "Partner annual super contribution",
    "auPartnerSuperContributionGuide": "Annual contribution used to project the partner's future super balance.",
    "auPartnerSuperReturnLabel": "Partner super expected return",
    "auPartnerSuperReturnGuide": "Annual return used to project the partner's super balance.",
    "auPartnerSuperEndAgeLabel": "Partner super contribution end age",
    "auPartnerSuperEndAgeGuide": "Annual contributions are added to the projected balance until this age.",
    "auPartnerReceivingSuperPensionLabel": "Partner has already started a super income stream",
    "auPartnerSuperProjectionNote": "While your partner is under age {age} and has not started a super income stream, their accumulation-phase super is excluded from assets and deemed income. It is included automatically once they reach {age}.",
    "ageYearsUnit": "years",
    ...
    "gbAnnualIncomeGuide": "[Enter your total annual income]\nSalary, pension and so on, before tax. This drives Income Tax, Dividend Tax, CGT and pension tax relief. National Insurance uses the employment-income field below.",
    "gbEmploymentIncomeLabel": "Annual employment income (NI)",
    "gbEmploymentIncomeGuide": "Enter annual employment earnings subject to Class 1 employee National Insurance. If zero, total annual income is used as an estimate. Do not include pensions, dividends or other income that is not subject to employee NI.",
    "gbNationalInsuranceLabel": "National Insurance",
    "gbNationalInsuranceSub": "2026/27 Class 1 category A estimate: 8% from £{pt} to £{uel}, then 2%",
    ...
    "auEstateSuperDeathTitle": "Estimated tax on a Super death-benefit lump sum",
    "auEstateNoInheritanceTaxNote": "Australia has no general inheritance tax. Separate tax rules can still apply to Super death benefits and income earned by a deceased estate.",
    "auEstateSuperDeathEnable": "Estimate tax on a Super death-benefit lump sum",
    "auEstatePaymentRoute": "Payment route",
    "auEstateRouteDirect": "Paid directly to beneficiary",
    "auEstateRouteEstate": "Paid via deceased estate",
    "auEstateDependantShareLabel": "Share ultimately benefiting death benefits dependants",
    "auEstateDependantShareGuide": "For an estate with multiple beneficiaries, enter 0–100% for the portion ultimately benefiting tax-law death benefits dependants. The remainder is treated proportionally as non-dependant.",
    "auEstateEstateSplitTaxSub": "Estate route: 15% max on taxed element / 30% max on untaxed element, proportionally applied to the {{share}}% non-dependant share",
    "auEstateRouteEstateNote": "For a deceased-estate trustee, this estimate applies the beneficiary dependency treatment but does not add Medicare levy. The trustee reports the Super lump sum in the deceased-estate trust return.",
    "auEstateNonDependantEstateTaxSub": "Via deceased estate: taxed element max 15% / untaxed element max 30%; Medicare levy not added in this estimate",
    "auEstateBeneficiaryType": "Beneficiary status for tax purposes",
    "auEstateDependant": "Death benefits dependant",
    "auEstateNonDependant": "Non-dependant",
    "auEstateTaxFreeLabel": "Tax-free component",
    "auEstateTaxFreeGuide": "Enter the tax-free component shown by the Super fund or payment summary.",
    "auEstateTaxedLabel": "Taxable component — taxed element",
    "auEstateTaxedGuide": "Enter the taxed element. For a direct lump sum to a non-dependant, the maximum rate is 15% plus Medicare levy.",
    "auEstateUntaxedLabel": "Taxable component — untaxed element",
    "auEstateUntaxedGuide": "Enter the untaxed element. For a direct lump sum to a non-dependant, the maximum rate is 30% plus Medicare levy.",
    "auEstateIncludeMedicareLevy": "Include 2% Medicare levy for a direct payment",
    "auEstateGrossLabel": "Gross death benefit",
    "auEstateGrossSub": "Total of the three entered components",
    "auEstateTaxLabel": "Estimated tax",
    "auEstateDependantTaxFreeSub": "A lump sum to a death benefits dependant is generally tax free",
    "auEstateNonDependantTaxSub": "Taxed element 15% / untaxed element 30% (plus 2% Medicare levy when selected)",
    "auEstateNetLabel": "Estimated net benefit",
    "auEstateNetSub": "Gross death benefit less estimated tax",
    "auEstateSuperDeathLimitNote": "This estimate covers a Super death-benefit lump sum paid directly to an individual or via a deceased estate. It does not automate income streams, mixed beneficiaries, special dependant rules, CGT or other deceased-estate income.",
    "auEstateIncomeStreamEnable": "Also check a Super death-benefit income stream",
    "auEstateIncomeStreamRecipientAge": "Recipient age",
    "auEstateIncomeStreamDeceasedAge": "Age of deceased at death",
    "auEstateIncomeStreamTaxFree": "Tax-free amount",
    "auEstateIncomeStreamTaxFreeSub": "Tax-free component plus taxed element where the age-60 condition applies",
    "auEstateIncomeStreamAssessable": "Assessable amount",
    "auEstateIncomeStreamAssessableSub": "Amount included in assessable income (not final tax payable)",
    "auEstateIncomeStreamOffset": "Tax offset",
    "auEstateIncomeStreamOffsetSub": "Applicable 15% taxed-element or 10% untaxed-element offset",
    "auEstateIncomeStreamNonDependantNote": "A death-benefit income stream to a non-dependant is outside this simplified estimator.",
    "auEstateIncomeStreamLimitNote": "Shows the tax classification and offsets for a death-benefits dependant. Final income tax is not calculated because other taxable income, Medicare levy and defined-benefit rules may be required.",
    ...
    "jpPublicPensionSectionLabel": "Japan public pension (Basic + Employees' Pension)",
    "jpPublicPensionGuide": "Enter the estimated monthly Basic Pension plus Employees' Pension at age 65. Changing the claim age from 60 to 75 applies Japan's statutory early/deferral adjustment to the public pension only, calculated by month. The rate is not applied to corporate pension funds, the National Pension Fund, or private annuities. Separate deferral of Basic and Employees' Pension, earnings-test suspensions, dependent supplements and similar adjustments are outside this simplified calculation.",
    "jpPublicPensionAt65Label": "Estimated public pension at age 65",
    "publicPensionStartAgeShort": "Claim age",
    "jpPublicPensionAdjustmentLabel": "Early/deferral adjustment",
    "jpPublicPensionAdjustedLabel": "Public pension after claim-age adjustment",
    "jpPublicPensionBirthDateNote": "No birth date is entered, so the estimate uses the current 0.4% monthly early-claim reduction and a maximum deferral age of 75. Enter a birth date to detect older rules automatically.",
    "jpOtherPensionsLabel": "Other pensions (calculated separately)",
    "jpOtherPensionsGuide": "Register corporate pension funds, the National Pension Fund and similar pensions here. Each amount starts at its own claim age and does not receive the public-pension early/deferral adjustment. Private annuity insurance remains in the separate Private Pension section below.",
    "pensionStartCol": "Starts",
    "pensionStartShort": "Starts",
    "pensionNamePlaceholderOther": "e.g. corporate pension fund, National Pension Fund",
    "jpPensionCombinedLabel": "Combined monthly pension under current settings",
    "jpPensionSeparationNote": "Japan's public pension is calculated separately from other pensions. Public-pension early/deferral adjustments are not applied to corporate pension funds, the National Pension Fund, or private annuities.",
  ...
  "usEstatePlannerTitle": "U.S. Estate Tax planning estimate (2026)",
  "usEstatePlannerNote": "The federal figure is a planning estimate using the 2026 basic exclusion. State entries show whether estate/inheritance tax applies, the exemption and rate range; confirm filing liability with the state or a qualified adviser.",
  "usEstateGrossLabel": "Gross estate",
  "usEstateGrossGuide": "Approximate value at death of real estate, investments, cash, business interests and other property.",
  "usEstateDebtsLabel": "Deductible debts and expenses",
  "usEstateDebtsGuide": "Approximate deductible debts and administration expenses.",
  "usEstateSpouseDeductionLabel": "Marital deduction estimate",
  "usEstateCharityDeductionLabel": "Charitable deduction estimate",
  "usEstatePriorGiftsLabel": "Exclusion already used by prior taxable gifts",
  "usEstatePriorGiftsGuide": "Approximate unified exclusion already consumed by lifetime taxable gifts.",
  "usEstateDsueLabel": "DSUE amount",
  "usEstateDsueGuide": "Enter only a confirmed deceased-spousal unused exclusion available through portability.",
  "usEstateNetEstateLabel": "Net estate",
  "usEstateAvailableExclusionLabel": "Available federal exclusion",
  "usEstate2026ExclusionSub": "Uses the 2026 $15,000,000 basic exclusion per person",
  "usEstateTaxableAboveLabel": "Amount above exclusion",
  "usEstateFederalTaxLabel": "Federal estate tax estimate",
  "usEstateFederalTaxSub": "Conservative estimate at 40% of the excess",
  "usEstateStateLabel": "State / D.C. death-tax check",
  "usEstateStateNone": "Select state",
  "usEstateStateTaxApplies": "{code}: {types} applies. Estate-tax exemption reference {exemption}; rate range {min}%–{max}% as of Jan. 1, 2026.",
  "usEstateStateTaxNone": "{code}: no state estate/inheritance tax shown in the 2026 table.",
  "usEstateTypeEstate": "Estate tax",
  "usEstateTypeInheritance": "Inheritance tax",
  "usEstateVariesByHeir": "varies by heir class",
  "usEstateNyCliffNote": "New York has a cliff above 105% of the exemption, so do not use a simple exemption subtraction near that boundary.",
