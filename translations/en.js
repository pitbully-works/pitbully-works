...
export const EN_TRANSLATIONS = {
    ...
    "surplusBalanceCurrentLabel": "Current surplus balance",
    "surplusBalanceCurrentSub": "The current balance set aside as surplus within your bank deposits. Income from public pension, private pension, iDeCo and the like, minus living costs, medical costs, insurance premiums and loan repayments, is added to it. It decreases when you spend surplus or run a living-cost deficit. Because it is part of your bank deposits, it is not double-counted in your total assets.",
    ...
    "initialSurplusLabel": "Current surplus balance",
    "initialSurplusExplain": "Enter the surplus you have accumulated so far. It is tracked as money available for unexpected expenses. It is the portion of your total bank deposits that you want to set aside as surplus.",
    "emergencyFundLabel": "Emergency fund",
    "emergencyFundExplain": "Enter the minimum cash you want to keep aside for sudden income loss or illness. This amount is subtracted when showing your \"free to spend now\" figure (it does not change the asset calculation itself).",
    "freeToSpendLabel": "Free to spend now",
    "freeToSpendExplain": "Your currently accessible assets minus your emergency fund and any planned expenses within the next {years} years. It never goes below zero.",
    "availableAtAgeLabel": "Available at age {age}",
    "availableAtAgeExplain": "An estimate of what you could spend at that age: your usable assets minus the minimum you want to leave (e.g., for inheritance). It never goes below zero. It is a static estimate under current conditions and does not affect the asset calculation.",
    ...
    "dashEmergencyLabel": "Emergency fund",
    "dashFreeToSpendLabel": "Free to spend now",
    "dashAssetsAtAgeLabel": "Assets at age {age}",
    "dashEmptyHint": "Pick a country and enter your assets to see a summary of what you have now, in the future, and what's free to spend.",
    ...
    "dashSurplusHint": "The part of your bank deposits set aside as surplus. Not double-counted in total assets.",
    "dashEmergencyHint": "The minimum cash you want to keep (display-only). It is subtracted when computing free-to-spend.",
    "dashFreeToSpendHint": "Accessible assets minus your emergency fund and near-term planned expenses. Never below zero.",
    ...
    "dashOpenSurplus": "Use surplus / try a sudden expense →",
    "walletDashboardNote": "Everything here is read from the same integrated calculation as your net-worth chart. Current surplus, emergency fund and free-to-spend are display-only and are not double-counted in your total assets. The age 65/75/95 figures are net worth (projected, after subtracting debt).",
    "whatIfTitle": "Sudden expense (what-if)",
    "whatIfAmountLabel": "Amount to spend from surplus",
    "whatIfEmpty": "Enter an amount to see a before/after comparison. Your inputs, history and saved data are not changed.",
    "whatIfColItem": "Item",
    "whatIfColBefore": "Before",
    "whatIfColAfter": "After",
    "whatIfColDelta": "Change",
    "whatIfSurplusLabel": "Surplus",
    "whatIfBankLabel": "Bank balance",
    "whatIfTotalLabel": "Total assets",
    "whatIfDepletionLabel": "Assets run out",
    "whatIfInsufficient": "Surplus is not enough, so only {spent} of {requested} can be used. Unprocessed amount: {shortfall}.",
    "whatIfNote": "This is a temporary estimate. Your inputs, history and saved data are not changed. Only surplus can be used; any excess is not taken from ordinary bank deposits. Ages 65/75/95 are net worth (projected, after debt).",
    ...
    "surplusTransferNote": "This is a record-only label. No money is actually moved between accounts, so your total assets and future projected returns are unchanged (choosing \"Move to NISA\" does not actually move funds from your bank into NISA for tax-free growth).",
    ...
    "surplusRequestedLabel": "Requested",
    "surplusSpentLabel": "Actually used",
    "surplusShortfallLabel": "Short by",
