...
export const EN_TRANSLATIONS = {
    ...
    "nominalValueNote": "Living costs, healthcare and fixed-cost inputs are entered in today's price terms. When inflation is enabled, price growth from today onward is reflected in future spending. Nominal assets show the actual projected money amount at each future date.",
    ...
    "annualCashflowTitle": "Annual retirement cash flow and asset change (projection)",
    "annualCashflowGuide": "Shows the pension income, living costs, healthcare, taxes/fixed costs, loan payments and investment return actually used by the integrated projection for each year. Values are projections. Private pension receipts can include transfers from the policy reserve, so the simple sum of columns may not exactly equal the asset change.",
    "cashflowTooltipTitle": "Latest 12-month cash flow",
    "cashflowIncomeLabel": "Pension income",
    "cashflowOpeningAssetsLabel": "Opening assets",
    "cashflowClosingAssetsLabel": "Closing assets",
    "cashflowInvestmentReturnLabel": "Investment return",
    "cashflowPublicPensionLabel": "Public pension",
    "cashflowPrivatePensionLabel": "Private pension",
    "cashflowLivingCostLabel": "Living costs",
    "cashflowHealthCostLabel": "Healthcare / age-75 premium",
    "cashflowTaxFixedCostLabel": "Taxes / fixed costs",
    "cashflowInsuranceLabel": "Insurance premiums",
    "cashflowLoanLabel": "Loan payments",
    "cashflowAnnualNetLabel": "Annual cash flow",
    "cashflowAssetChangeLabel": "Asset change",
    ...
    "statRealNetWorthFinalLabel": "Real net worth at {age} (today's value)",
    "statRealNetWorthFinalSub": "Converted to today's purchasing power using {pct}% inflation",
    "statRealNetWorthNoInflationSub": "Same as nominal value because inflation is off",
    "assetValueModeNominal": "Nominal assets",
    "assetValueModeReal": "Real assets (today's value)",
    "assetValueModeNominalGuide": "Shows the amount of money projected at each future date.",
    "assetValueModeRealGuide": "Discounts future asset values back to today's purchasing power using {pct}% inflation. This changes only the display, not the underlying projection.",
    "cashflowTotalIncomeLabel": "Cash income total",
    "cashflowTotalOutflowLabel": "Cash outflow total",
    "cashflowRealClosingAssetsLabel": "Closing assets (today's value)",
};
