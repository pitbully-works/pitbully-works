...
export const EN_TRANSLATIONS = {
    ...
    "annualCashflowGuide": "This table shows how money moves each year. It starts with the money you have at the beginning of the year, reflects pension income and investment growth, then subtracts living costs, healthcare, taxes, insurance and loan payments to show what is left at year-end. All figures are projections. Private pension payments can include transfers from the policy reserve, so simply adding and subtracting every column may not exactly match the change in assets.",
    "annualCashflowTermsGuide": "‘Yearly surplus / shortfall’ is money received during the year minus money spent. ‘Increase / decrease in assets’ also reflects investment growth and transfers between asset buckets. ‘Money left at year-end’ shows the projected amount remaining after that year. ",
    "cashflowTooltipTitle": "Money movement over this year",
    "cashflowIncomeLabel": "Money received from pensions",
    "cashflowOpeningAssetsLabel": "Money at start of year",
    ...
    "cashflowAssetChangeLabel": "Increase / decrease in assets",
    ...
    "assetValueModeReal": "Assets converted to today's money",
    ...
    "cashflowRealClosingAssetsLabel": "Year-end assets converted to today's money",
};
