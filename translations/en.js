...
export const EN_TRANSLATIONS = {
    ...
    "auConcessionalOverProjectionNote": "The {excess} above the {cap} cap is not projected as a pre-tax contribution. In reality the excess is added to your taxable income and taxed at your marginal rate, with the 15% already deducted allowed as an offset, and you can choose to leave it in super or release up to 85% of it. This app implements neither those rules nor carry-forward contributions, so it takes the conservative path and leaves the excess out rather than overstating your balance.",
