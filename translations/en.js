...
export const EN_TRANSLATIONS = {
    ...
    "caCppEiLabel": "{plan} contributions + EI",
    "caCppEiSub": "{plan} employee contribution {pension} + EI employee premium {ei}",
    ...
    "caTaxSourceNote": "Federal income tax, capital gains, CPP/QPP contributions and EI premiums are estimates based on published {taxYear} figures. Provincial income tax is currently automated for Ontario only; dividend tax credits, AMT and QPIP are not implemented.",
    "caTfsaLabel": "TFSA",
    ...
    "caTotalTaxSub": "Income tax + capital gains + CPP/QPP + EI − RRSP tax saving",
