...
export const EN_GB_OVERRIDES = {
  ...
  gbCountryNote: "UK edition: ISA and pension allowances, State Pension, Income Tax (including Scottish Income Tax), Class 1 employee National Insurance, Dividend Tax, Capital Gains Tax and core Inheritance Tax thresholds use official 2026/27 figures. Some detailed estate and healthcare rules remain outside the automatic calculation. This is a planning tool, not financial advice.",
  ...
  statStockValueNowLabel: "Stocks & Shares Cost Basis (Current Principal)",
  stockCurrentTotalLabel: "Stocks & Shares Cost Basis (Total)",
  stockReturnLabel: "Expected Annual Return Until {age} (All Stocks & Shares)",
  stockWatchlistTitle: "Stocks & Shares Holdings (enter shares and average acquisition price)",
  ...
  surplusCategory_toNisa: "Move to ISA",
    ...
    "fixedCostNamePlaceholder": 'e.g. Council Tax, vehicle tax, service charge',
    ...
    "publicPensionTaxModeLabel": 'Tax on State/public pension',
    "taxModeAuto": 'Automatic estimate',
    "taxModeManual": 'Enter manually',
    "manualTaxAnnualLabel": 'Tax amount (annual, manual)',
    "estimatedPublicPensionTaxLabel": 'Estimated pension tax',
    ...
    "pensionTakeHomeDisclaimer": 'Calculated by subtracting the annual estimated State/public pension tax once from annual pension income, then dividing by 12. Private-pension tax and other taxes/fixed costs are not included in this figure.',
    "retirementTaxDisclaimer": 'This is a simplified estimate only. Actual tax can differ due to age, other income, tax code, allowances, location, payment method and future tax-law changes. Check HMRC or a qualified adviser for an exact figure.',
    ...
    "navShortGuide": "Guide",
    "guideEasyRequiredPublicPension": "State Pension",
    "guideEasyRecommendedNisa": "ISA / other investments",
    "guideEasyRecommendedIdeco": "SIPP / Workplace Pension",
    "guideEasyRecommendedCash": "Cash savings",
