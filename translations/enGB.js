...
export const EN_GB_OVERRIDES = {
  ...
  statStockValueNowLabel: "Stocks & Shares Acquisition Cost (Current)",
  stockAcquisitionTotalLabel: "Stocks & Shares Acquisition Cost (Total)",
  stockReturnLabel: "Expected Annual Return Until {age} (All Stocks & Shares)",
  averageAcquisitionCostCol: "Average Acquisition Cost",
  stockWatchlistTitle: "Stocks & Shares Holdings (enter shares and average acquisition cost)",
