...
export const JA_TRANSLATIONS = {
    ...
    "guideStep3Desc": "公的年金・企業年金・民間年金と、老後に毎月使う生活費を現在の物価感覚で入力します。",
    "guideStep4Title": "支出を入力",
    "guideStep4Desc": "借入、保険料、税金・固定費など、退職後も続く支出を必要な範囲で入力します。",
    ...
    "guideStep7Desc": "条件を変えた比較と資産推移グラフで、何歳で増減するか、想定寿命時点にいくら残るかを確認します。",
    "guideOpenStep": "ここへ進む",
