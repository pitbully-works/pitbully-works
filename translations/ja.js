...
export const JA_TRANSLATIONS = {
    ...
    "gbLifetimeIsaLimitLabel": "LISA 年間拠出上限",
    "gbLifetimeIsaBonusLabel": "現在入力の政府ボーナス見込：{amount}",
    "gbLifetimeIsaNote": "LISAは50歳になるまで拠出でき、退職目的では原則{accessAge}歳からペナルティなしで利用できます。年間拠出額はISA全体の年間枠にも含まれます。",
    ...
    "gbTaxSourceNote": "Income Tax・National Insurance・Dividend Tax・Capital Gains Tax・貯蓄利子課税は{taxYear}年度のGOV.UK公表値に基づく概算です（{region}基準）。Scottish Income Taxにも対応し、Inheritance Taxは相続セクションで概算します。",
    ...
    "caEmploymentIncomeLabel": "年間給与所得（CPP/QPP・EI対象）",
    "caEmploymentIncomeGuide": "給与・賃金などの雇用所得を入力します。0の場合は後方互換のため年間総所得を給与所得として概算します。",
    "caCppEiLabel": "{plan}拠出金＋EI＋QPIP",
    "caCppEiSub": "{plan}本人分 {pension} ＋ EI {ei} ＋ QPIP {qpip}（QPIPはQuebecのみ）",
    ...
    "caQppEarlyRateGuide": "QPPの65歳前の減額率は、年金額などにより1か月あたり0.5〜0.6%です。Retraite Québecの見込額・明細で分かる場合はその率に合わせてください。",
    "caQppAnnualSub": "Retraite Québecの見込額 × 受給開始年齢による増減",
    ...
    "caQuebecAbatementLabel": "Quebec連邦税減額",
    "caQuebecAbatementSub": "Basic Federal Taxの{pct}を減額",
    ...
    "caTaxSourceNote": "連邦所得税・譲渡益課税・CPP/QPP拠出金・EI保険料・QuebecのQPIPは{taxYear}年の公表値に基づく概算です。州所得税はオンタリオとケベックを自動計算し、ケベック居住者には連邦税16.5%減額も反映します。その他の州・準州、配当税額控除・AMTは未実装です。",
    "caTfsaLabel": "TFSA",
    ...
    "caTfsaOfficialRoomLabel": "当年1月1日時点のTFSA利用可能枠（分かる場合）",
    "caTfsaOfficialRoomGuide": "自分の取引記録で計算した当年の利用可能枠が分かる場合に入力してください。0の場合は、年間枠＋前年末未使用枠＋前年引出額で概算します。",
    "caTfsaPriorUnusedLabel": "前年末までの未使用TFSA枠",
    "caTfsaPriorWithdrawalLabel": "前年のTFSA引出額",
    "caTfsaPriorWithdrawalGuide": "前年の引出額は翌年1月1日に利用可能枠へ戻ります。当年中の引出額は今年の枠には戻りません。",
    "caTfsaRoomTotalSub": "年間上限は {amount}。実際の利用可能枠には未使用枠と前年引出額も加わります",
    "caTotalAssetsLabel": "総資産（4口座の合計）",
    "caTotalAssetsSub": "TFSA＋RRSP＋非登録口座＋現金貯蓄のすべての合計",
    "caTotalTaxLabel": "税・給与天引き合計（概算）",
    "caTotalTaxSub": "所得税＋譲渡益課税＋CPP/QPP＋EI＋QPIP − RRSP拠出による軽減",
    ...
    "auPartnerCurrentAgeLabel": "配偶者の現在年齢",
    "auPartnerCurrentAgeGuide": "Age Pension投影で、配偶者が{age}歳に達する時期を自動判定します。",
    "auPartnerSuperLabel": "配偶者の現在Super残高",
    "auPartnerSuperGuide": "配偶者本人のSuper残高です。67歳未満かつincome stream未開始ならAge Pensionの資産・Deeming対象から除外します。",
    "auPartnerSuperContributionLabel": "配偶者の年間Super拠出",
    "auPartnerSuperContributionGuide": "配偶者Superの将来残高を投影するための年間拠出額です。",
    "auPartnerSuperReturnLabel": "配偶者Super想定年率",
    "auPartnerSuperReturnGuide": "配偶者Super残高の将来投影に使う年率です。",
    "auPartnerSuperEndAgeLabel": "配偶者Super拠出終了年齢",
    "auPartnerSuperEndAgeGuide": "この年齢までは年間Super拠出を将来残高へ加算します。",
    "auPartnerReceivingSuperPensionLabel": "配偶者がSuper income streamをすでに受給中",
    "auPartnerSuperProjectionNote": "配偶者が{age}歳未満でSuper income stream未開始の間は、その積立フェーズSuperを資産・みなし所得から除外します。{age}歳到達後は自動で算入します。",
    "ageYearsUnit": "歳",
    ...
    "gbAnnualIncomeGuide": "【年間の総所得を入れてください】\n給与・年金などの合計（税引前）です。Income Tax、Dividend Tax、CGT、年金拠出の税軽減の判定に使われます。National Insuranceは下の給与所得欄を使います。",
    "gbEmploymentIncomeLabel": "年間給与所得（NI対象）",
    "gbEmploymentIncomeGuide": "Class 1 employee National Insuranceの対象となる年間給与を入力します。0の場合は年間総所得を給与として概算します。年金・配当・利子などNI対象外の所得は含めません。",
    "gbNationalInsuranceLabel": "National Insurance",
    "gbNationalInsuranceSub": "2026/27 Class 1 category A概算：£{pt}超〜£{uel}は8%、超過分は2%",
    ...
    "nameCol": "名前",
    "nameLabel": "お名前（任意）",
    "jpPublicPensionSectionLabel": "公的年金（老齢基礎年金＋老齢厚生年金）",
    "jpPublicPensionGuide": "65歳時点の老齢基礎年金＋老齢厚生年金の月額見込を入力してください。受給開始年齢を60〜75歳の範囲で変更すると、公的年金だけに法定の繰上げ・繰下げ率を月単位で自動反映します。企業年金基金・国民年金基金・個人年金にはこの率を掛けません。老齢基礎年金と老齢厚生年金を別々に繰下げるケース、在職老齢年金による支給停止、加給年金・振替加算等はこの簡易計算の対象外です。",
    "jpPublicPensionAt65Label": "65歳時点の公的年金見込額",
    "publicPensionStartAgeShort": "受給開始",
    "jpPublicPensionAdjustmentLabel": "繰上げ・繰下げ調整率",
    "jpPublicPensionAdjustedLabel": "受給開始年齢反映後の公的年金",
    "jpPublicPensionBirthDateNote": "生年月日が未入力のため、繰上げは現行の月0.4%減額・繰下げ上限75歳として概算しています。生年月日を入力すると旧制度対象者の月0.5%減額や繰下げ上限70歳を自動判定します。",
    "jpOtherPensionsLabel": "その他の年金（公的年金とは別計算）",
    "jpOtherPensionsGuide": "企業年金基金、国民年金基金などを登録してください。各年金は登録した受給開始年齢から月額を加算します。公的年金の繰上げ・繰下げ率は適用しません。個人年金保険は下の「民年金」ページで別管理します。",
    "pensionStartCol": "受給開始",
    "pensionStartShort": "受給開始",
    "pensionNamePlaceholderOther": "例：企業年金基金、国民年金基金",
    "jpPensionCombinedLabel": "受給開始後の年金月額合計（現在設定）",
    "jpPensionSeparationNote": "公的年金とその他の年金を分離して計算します。公的年金の繰上げ・繰下げによる増減は、企業年金基金・国民年金基金・民間の個人年金には反映しません。",
  ...
  "usEstatePlannerTitle": "米国 相続税・Estate Tax 概算（2026）",
  "usEstatePlannerNote": "連邦Estate Taxは2026年の基本控除額を使った計画用概算です。州税は州ごとの課税有無・控除額・税率範囲を確認し、厳密な申告額は専門家・州当局で確認してください。",
  "usEstateGrossLabel": "総遺産額",
  "usEstateGrossGuide": "死亡時点で保有する不動産・投資・現金・事業持分などの概算総額です。",
  "usEstateDebtsLabel": "控除対象の債務・費用",
  "usEstateDebtsGuide": "控除対象となる債務や管理費用などの概算です。",
  "usEstateSpouseDeductionLabel": "配偶者控除見込み",
  "usEstateCharityDeductionLabel": "慈善寄付控除見込み",
  "usEstatePriorGiftsLabel": "過去の課税贈与による控除枠使用額",
  "usEstatePriorGiftsGuide": "生前贈与で既に統一控除枠を使っている場合の概算額です。",
  "usEstateDsueLabel": "DSUE追加控除額",
  "usEstateDsueGuide": "亡くなった配偶者からportabilityで利用できるDSUEが確定している場合だけ入力します。",
  "usEstateNetEstateLabel": "控除後遺産額",
  "usEstateAvailableExclusionLabel": "利用可能な連邦控除枠",
  "usEstate2026ExclusionSub": "2026年基本控除 $15,000,000/人を基準",
  "usEstateTaxableAboveLabel": "控除枠超過額",
  "usEstateFederalTaxLabel": "連邦Estate Tax概算",
  "usEstateFederalTaxSub": "超過額×40%の保守的な概算",
  "usEstateStateLabel": "州・D.C.の死亡時課税確認",
  "usEstateStateNone": "州を選択",
  "usEstateStateTaxApplies": "{code}：{types}あり。Estate Tax控除目安 {exemption}、税率範囲 {min}%〜{max}%（2026年1月1日時点）。",
  "usEstateStateTaxNone": "{code}：2026年州Estate/Inheritance Tax一覧では該当なし。",
  "usEstateTypeEstate": "Estate Tax",
  "usEstateTypeInheritance": "Inheritance Tax",
  "usEstateVariesByHeir": "相続人区分で異なる",
  "usEstateNyCliffNote": "New Yorkは控除額の105%を超えると控除が消えるcliffがあるため、境界付近では単純な控除差引き計算を使わないでください。",
