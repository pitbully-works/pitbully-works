...
export const JA_TRANSLATIONS = {
    ...
    "assetValueModeNominal": "物価上昇を反映した資産",
    "assetValueModeReal": "今の価値に換算した金額",
    "assetValueModeNominalGuide": "将来その時点で表示される資産額です。生活費などには設定した物価上昇を反映します。",
    "assetValueModeRealGuide": "将来の資産額を、物価上昇率{pct}%を使って『今のお金ならいくらの価値か』に換算して表示します。資産計算そのものは変えず、見え方だけを切り替えます。",
