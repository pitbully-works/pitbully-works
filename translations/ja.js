...
export const JA_TRANSLATIONS = {
    ...
    "nominalValueNote": "生活費・医療費・固定費などの入力金額は現在の物価感覚を基準にします。インフレを有効にすると、現在から将来までの物価上昇を支出へ反映します。総資産の『名目資産』は、その将来時点の金額そのものです。",
    ...
    "taxModeOff": '計算しない',
    "annualCashflowTitle": "退職後の年間収支・資産変化（予測）",
    "annualCashflowGuide": "統合計算で実際に使った年金・生活費・医療費・税金・固定費・ローン・運用益を1年ごとに表示します。金額は予測値です。民間年金は契約受取額を表示し、払込元本からの資金移動を含むため、各列の単純合計と資産増減が完全一致しない場合があります。",
    "cashflowTooltipTitle": "直近1年の収支",
    "cashflowIncomeLabel": "年金収入",
    "cashflowOpeningAssetsLabel": "期首資産",
    "cashflowClosingAssetsLabel": "期末資産",
    ...
    "cashflowHealthCostLabel": "医療費・75歳保険料",
    "cashflowTaxFixedCostLabel": "税金・固定費",
    "cashflowInsuranceLabel": "保険料",
    "cashflowLoanLabel": "ローン返済",
    "cashflowAnnualNetLabel": "年間収支",
    "cashflowAssetChangeLabel": "資産増減",
    ...
    "statRealNetWorthFinalLabel": "{age}の実質純資産（現在価値）",
    "statRealNetWorthFinalSub": "インフレ率{pct}%で現在の購買力に換算",
    "statRealNetWorthNoInflationSub": "インフレを考慮しないため名目値と同じ",
    "assetValueModeNominal": "名目資産",
    "assetValueModeReal": "実質資産（現在価値）",
    "assetValueModeNominalGuide": "将来時点の金額そのものを表示します。",
    "assetValueModeRealGuide": "将来の資産額をインフレ率{pct}%で現在の購買力に割り戻して表示します。計算結果そのものは変えず、見え方だけを切り替えます。",
    "cashflowTotalIncomeLabel": "現金収入計",
    "cashflowTotalOutflowLabel": "現金支出計",
    "cashflowRealClosingAssetsLabel": "期末資産（現在価値）",
};
