...
export const JA_TRANSLATIONS = {
    ...
    "daysUnit": "日",
    "auTaxSourceNote": "所得税・Medicare levy・譲渡益課税は{taxYear}年度のATO公表値に基づく概算です。LITO・SAPTO、単身・家族のMedicare levy低所得減免、MLSを反映しています。Medicare levyの年途中の日割り免除とHECS-HELPの返済は未実装です。",
