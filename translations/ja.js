...
export const JA_TRANSLATIONS = {
    ...
    "annualCashflowGuide": "この表では、1年ごとのお金の動きを確認できます。『今年のはじめの資産』に、年金収入や投資で増えたお金を反映し、生活費・医療費・税金・保険料・ローン返済などを差し引いた結果が『年末に残る資産』です。金額は将来予測です。民間年金は契約から受け取るお金の移動を含むため、各欄を単純に足し引きした数字と『資産の増減』が完全に一致しない場合があります。",
    "annualCashflowTermsGuide": "『1年間の黒字・赤字』は、その年にもらうお金から使ったお金を引いた結果です。『資産が増えた・減った額』には、これに加えて投資で増えたお金や資産内の資金移動なども反映されます。『年末に残る資産』を見ると、その年の最後に資産がいくら残る予測か分かります。",
    "cashflowTooltipTitle": "この1年間のお金の動き",
    "cashflowIncomeLabel": "年金でもらうお金",
    "cashflowOpeningAssetsLabel": "今年のはじめの資産",
    ...
    "cashflowAssetChangeLabel": "資産が増えた・減った額",
    ...
    "assetValueModeReal": "今のお金の価値に換算した資産",
    ...
    "cashflowRealClosingAssetsLabel": "年末の資産を今のお金の価値に換算",
};
