...
export const JA_TRANSLATIONS = {
    ...
    "daysUnit": "日",
    "auTaxSourceNote": "所得税・Medicare levy・譲渡益課税は{taxYear}年度のATO公表値に基づく概算です。LITO・SAPTOと単身者のMedicare levy低所得減免を反映しています。家族所得によるMedicare levy減免とHECS-HELPの返済は未実装です。",
