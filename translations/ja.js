...
export const JA_TRANSLATIONS = {
    ...
    "auEstateIncomeStreamEnable": "Super死亡給付の所得ストリーム（年金形式）の税務区分も確認する",
    "auEstateRecipientAge": "受取人の年齢",
    "auEstateDeceasedAge": "死亡時の年齢",
    "auEstateAgeUnit": "歳",
    "auEstateIncomeStream_nonDependantIneligible": "Non-dependantは原則としてSuper死亡給付を所得ストリームとして受け取れません。一括支給の扱いを確認してください。",
    "auEstateIncomeStream_age60Plus": "Death benefits dependantで、受取人または死亡者が60歳以上：tax-free componentとtaxed elementは非課税。untaxed elementは課税所得ですが10% tax offsetの対象です。",
    "auEstateIncomeStream_bothUnder60": "Death benefits dependantで双方60歳未満：tax-free componentは非課税。taxed elementは課税所得で15% tax offset、untaxed elementは課税所得でoffsetなしです。",
