...
export const JA_TRANSLATIONS = {
    ...
    "livingCostCurrentValueNote": "生活費は現在の物価感覚で入力してください。インフレを有効にすると、現在から退職時までの物価上昇も含めて将来額へ自動換算します。",
    ...
    "otherAnnualTaxesGuide": '固定資産税・都市計画税・自動車税・HOA・Council Tax・管理費など、退職後も続く税金や固定費を年額で入力します。国ごとの制度差が大きいため自動計算せず任意入力とし、退職後の資産推移から毎年差し引きます。',
