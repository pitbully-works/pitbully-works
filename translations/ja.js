...
export const JA_TRANSLATIONS = {
    ...
    "auCarryForwardBalanceLabel": "前年6/30時点のSuper総残高（carry-forward判定）",
    "auCarryForwardBalanceGuide": "Carry-forward（繰越拠出）の資格判定に使います。前年6月30日時点のTotal superannuation balanceを入力してください。A$500,000未満の場合のみ、ATOに表示される利用可能な未使用枠を今年度の税引前拠出上限へ加算できます。",
