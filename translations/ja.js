...
export const JA_TRANSLATIONS = {
    ...
    "auConcessionalOverProjectionNote": "上限（{cap}）を超えた {excess} は、投影では税引前拠出として積み立てていません。実際には超過分は課税所得に加算されて限界税率で課税され、すでに引かれた15%が税額控除されます。さらに超過分をSuperに残すか85%まで払い戻すかを選べますが、本アプリはこれらと繰越拠出（carry-forward）を実装していないため、残高を過大に見せない安全側の扱いにしています。",
