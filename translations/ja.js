...
export const JA_TRANSLATIONS = {
    ...
    "gbTaxSourceNote": "Income Tax・National Insurance・Dividend Tax・Capital Gains Taxは{taxYear}年度のGOV.UK公表値に基づく概算です（{region}基準）。Scottish Income Taxにも対応し、Inheritance Taxは相続セクションで概算します。貯蓄利子課税は未実装です。",
