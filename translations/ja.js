...
export const JA_TRANSLATIONS = {
    ...
    "annualCashflowGuide": "この表では、1年ごとのお金の動きを確認できます。『その年のスタート時点の資産』に、年金収入や投資で増えたお金を反映し、生活費・医療費・税金・保険料・ローン返済などを差し引いた結果が『年末に残る資産』です。金額は将来予測です。民間年金は契約から受け取るお金の移動を含むため、各欄を単純に足し引きした数字と『投資などで増えた・減ったお金』が完全に一致しない場合があります。",
    "annualCashflowTermsGuide": "『1年間の黒字・赤字』は、その年にもらったお金から使ったお金を引いた結果です。『投資などで増えた・減ったお金』には、投資の利益・損失や資産内の資金移動なども反映されます。そのため、生活の収支が赤字でも、投資の利益が赤字額を上回れば資産全体が増えることがあります。『年末に残る資産』を見ると、その年の最後に資産がいくら残る予測か分かります。",
    "cashflowTooltipTitle": "この1年間のお金の動き",
    "cashflowIncomeLabel": "年金でもらうお金",
    "cashflowOpeningAssetsLabel": "その年のスタート時点の資産",
    "cashflowClosingAssetsLabel": "年末に残る資産",
    "cashflowInvestmentReturnLabel": "投資で増えたお金",
    "cashflowPublicPensionLabel": "公的年金でもらうお金",
    "cashflowPrivatePensionLabel": "民間年金でもらうお金",
    "cashflowLivingCostLabel": "生活費",
    "cashflowHealthCostLabel": "医療にかかるお金",
    "cashflowTaxFixedCostLabel": "税金・毎年の固定支出",
    "cashflowInsuranceLabel": "保険料",
    "cashflowLoanLabel": "ローン返済",
    "cashflowAnnualNetLabel": "1年間の黒字・赤字",
    "cashflowAssetChangeLabel": "投資などで増えた・減ったお金",
    ...
    "cashflowTotalIncomeLabel": "1年間にもらうお金の合計",
    "cashflowTotalOutflowLabel": "1年間に使ったお金",
    "cashflowRealClosingAssetsLabel": "年末の資産を今の価値に換算した金額",
};
