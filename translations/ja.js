...
export const JA_TRANSLATIONS = {
    ...
    "caCppEiLabel": "{plan}拠出金＋EI保険料",
    "caCppEiSub": "{plan}本人分 {pension} ＋ EI本人分 {ei}",
    ...
    "caTaxSourceNote": "連邦所得税・譲渡益課税・CPP/QPP拠出金・EI保険料は{taxYear}年の公表値に基づく概算です。州・準州所得税は現在オンタリオのみ自動計算、配当税額控除・AMT・QPIPは未実装です。",
    "caTfsaLabel": "TFSA",
    ...
    "caTotalTaxSub": "所得税＋譲渡益課税＋CPP/QPP＋EI − RRSP拠出による軽減",
