...
describe("GB 2026/27 final user-facing consistency", () => {
  ...
  it("no longer labels savings-interest tax as unimplemented", () => {
    expect(ja.gbTaxSourceNote).toContain("貯蓄利子課税");
    expect(ja.gbTaxSourceNote).not.toContain("貯蓄利子課税は未実装");
    expect(en.gbTaxSourceNote).toContain("savings-interest tax");
    expect(en.gbTaxSourceNote).not.toContain("Tax on savings interest is not implemented");
  });
});
