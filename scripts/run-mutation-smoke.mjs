...
const mutants = [
  ...
  ["Rule update persistence uses latest state", "App.jsx", "const persistRuleUpdateState = useCallback((nextOrUpdater) => {\n    setRuleUpdateState((current) => {", "const persistRuleUpdateState = useCallback((nextOrUpdater) => {\n    setRuleUpdateState(current);", "ruleUpdateStateConcurrency.test.js"],
